...
public class WordFreq implements Comparator<WordFreq>{
    ...
    private static final MyLinkedList <String> verbPostfix = new MyLinkedList<>("ζομαστε", "ζοταν", "ζεσαι", "ζεται", "ζεται", "ζομαι", "νομαστε", "ομαστε", "ομασταν", "ομασταν", "οσασταν", "ομουνα", "οσουνα", "ουσαμε", "ουσατε", "ουσαν", "ουσα", "ουσε", "ουσες",
                                                                                    ...
                                                                                    "στει", "στηκε", "νοταν", "νουμε", "νετε", "νεται", "νουν", "ασαμε", "ασατε", "ασουμε", "νουσαμε", "ναμε", "νας", "νησει", "αστουμε",
                                                                                    "ησουμε", "ησετε" , "ησουν", "ηθηκαν", "ηθηκε", "ησει", "ησετε", "ησουν", "αγαμε", "σαστε", "ησεις", "ησει",
                                                                                    "νουν", "νομουνα", "οτανε", "ουνταν","μασταν", "νομουν", "ομουν", "ζονται", "ονται", "ωμαστε", "ωσαστε","μαστε", "σαστε", "ζεσαι","οσουν", "τομαι", "νομαι", "ομαι",
                                                                                    ...
                                                                                    "χτω", "χτηκα", "χτεις", "χτηκε", "χτηκες", "χτουμε", "χτειτε", "χτουν", "τομουν", "τει", "ηθει", "ηθεις","θησα",
                                                                                    ...
                                                                                    "ζουνε", "ηκε", "ηκα", "αξα", "ζων", "ζας", "ζης", "χτει", "ναει", "εσε", "χνω", "ειτε", "ετε", "εται",
                                                                                    ...
                                                                                    "ξουνε", "ξεις", "ξει", "ξουμε", "ξετε", "ξουν", "σω", "σω", "ζεις", "νεις", "νει", "ναμε", "νατε", "ναν",
