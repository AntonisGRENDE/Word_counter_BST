...
public class WordFreq implements Comparator<WordFreq>{
    ...
    private static final MyLinkedList <String> verbPostfix = new MyLinkedList<>("ζομαστε", "ζοταν", "ζεσαι", "ζεται", "ζεται", "ζομαι", "ομαστε", "ομασταν", "μαστε", "ομασταν" , "οσασταν", "ομουνα", "οσουνα", "ουσαμε", "ουσατε", "ουσαν",
                                                                                    "νησα", "νησε", "νησαμε", "νησατε", "νησαν", "νουμε", "νετε", "νουν", "ασαμε", "ασατε", "ασουμε", "νουσαμε", "ναμε", "νας", "νησει",
                                                                                    "ησουμε", "ησετε" , "ησουν", "ηθηκαν", "ηθηκε", "ησει", "ησετε", "ησουν", "σουμε",  "αγαμε", "σαστε", "ησεις", "ηση",
                                                                                    "ξουμε", "χνω", "χνεται", "σεις", "νουν", "ουσα", "ουσε", "ουσες", "οτανε", "ουνταν","μασταν", "ομουν", "οσουν",   "τομαι", "ομαι", "εθηκες", "εθηκε", "εθηκαμε", "εθηκατε", "εθηκαν",
                                                                                    "ζονται", "ονται",  "ωμαστε", "ωσαστε","μαστε", "σαστε", "ζεσαι", "στηκε", "στει", "στηκα", "στηκη", "ισεις", "σισουν", "σουμε", "ηθουμε", "θουμε", "ουμαι", "ηκαμε",
                                                                                    "ζουμε", "ιαιμαι", "εθηκα", "εσαι", "εται","οντε", "εσε", "χνω", "χνεις", "χνει", "ζουν", "ηθηκα",
                                                                                    "χνουμε", "χναμε", "χνατε", "χνετε", "χνεται", "χνουν", "χναν", "στει", "στηκε", "οταν", "ιζουμε", "χτω", "χτηκα", "τομαι", "τομουν", "τει", "ηθει", "ηθεις",
                                                                                    "ψει", "ιζετε", "σετε", "αξουνε", "αχνω","αξεις", "αξει", "αξουμε", "αξετε", "αξουν", "αγμενα", "αχνω", "θεις", "κα", "κες", "κε", "ειται",
                                                                                    "εμαι", "μαι", "σαι", "ναι", "νανε", "αζαν", "τσε", "ευω", "ευει", "θηκε", "αινω", "αινεις", "αινει", "αινουμε", "αινετε", "αινουν", "σουν",
                                                                                    ...
                                                                                    "στω", "ανε", "θουν","ουμε", "αεις", "ξεις", "ζει", "ουνε", "ζουν", "θει", "είς", "ατε", "γα", "με", "γε", "εσει","ησε", "σαν", "ξα", "ξω",
    ...
    private static final MyLinkedList <String> nounPostfix = new MyLinkedList<>("σμενος", "σμενη", "σμενο", "σμενοι", "σμενα", "ημενος", "ημενη", "ημενο", "ημενοι", "ημενα", "ημενες", "μενος", "μενο", "μενα", "μενοι", "μενη", "μενες", "οτητα", "οντας", "τσες", "οτα", "στης", "ουλα", "ατα", "ατη", "ατο", "ατου", "ατος", "ατες", "ατων", "κων", "ακι", "ωση", "τσα", "ακια", "τσικα", "σος", "σεων", "σεις", "ους", "κος",
